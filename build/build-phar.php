...
/**
 * PHAR build script for lphenom/db.
 *
...
$pharFile = $buildDir . '/lphenom-db.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-db.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-db.phar');
require 'phar://lphenom-db.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
